  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Mental Health Platform Specific Variants
        hero: "hero-gradient text-white font-semibold shadow-hover hover:scale-[1.02] transition-all duration-300",
        calm: "bg-calm text-calm-foreground hover:bg-calm/90 shadow-soft hover:shadow-hover",
        trust: "bg-trust text-trust-foreground hover:bg-trust/90 shadow-soft hover:shadow-hover",
        hope: "bg-hope text-hope-foreground hover:bg-hope/90 shadow-soft hover:shadow-hover",
        ...
        floating: "bg-card text-card-foreground shadow-hover hover:shadow-soft hover:-translate-y-1 transition-all duration-300 border border-border/50",
      },
      size: {
